...
- [从零开始学 Windows 批处理(Batch)编程系列教程](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzIwNDA3ODg3OQ==&action=getalbum&album_id=2998421546484350982&scene=173&from_msgid=2648003120&from_itemidx=1&count=3&nolastread=1#wechat_redirect)
