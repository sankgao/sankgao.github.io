...
- **%aL**：作者电子邮件的本地部分（`@` 符号之前的部分）
- **%ad**：作者日期。显示默认日期格式。例如：`Wed May 15 11:22:22 2024 +0800`
- **%aD**：作者日期。显示 RFC 2822 格式。例如：`Wed, 15 May 2024 11:22:22 +0800`
- **%ar**：作者日期。显示相对于当前时间的日期。例如：`28 hours ago`
- **%at**：作者日期。显示日期为 Unix 纪元时间戳。例如：`1715743342`
- **%ai**：作者日期。显示类似的 ISO 8601 格式。例如：`2024-05-15 11:22:22 +0800`
- **%aI**：作者日期。显示严格的 ISO 8601 格式。例如：`2024-05-15T11:22:22+08:00`
- **%as**：作者日期。只显示日期，而不显示时间。例如：`2024-05-15`
- **%ah**：作者日期。以易读形式显示。例如：`Wed 11:22`
...
- **%cL**：提交者电子邮件的本地部分（`@` 符号之前的部分）
- **%cd**：提交者日期。显示默认日期格式。例如：`Wed May 15 11:22:22 2024 +0800`
- **%cD**：提交者日期。显示 RFC 2822 格式。例如：`Wed, 15 May 2024 11:22:22 +0800`
- **%cr**：提交者日期。显示相对于当前时间的日期。例如：`28 hours ago`
- **%ct**：提交者日期。显示日期为 Unix 纪元时间戳。例如：`1715743342`
- **%ci**：提交者日期。显示类似的 ISO 8601 格式。例如：`2024-05-15 11:22:22 +0800`
- **%cI**：提交者日期。显示严格的 ISO 8601 格式。例如：`2024-05-15T11:22:22+08:00`
- **%cs**：提交者日期。只显示日期，而不显示时间。例如：`2024-05-15`
- **%ch**：提交者日期。以易读形式显示。例如：`Wed 11:22`
- **%d**：`ref` 名称
- **%D**：`ref` 名称，不带括号（`()`）包围
