import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,f as e}from"./app-icfFSHOT.js";const o={},t=e(`<h2 id="linux-系统重置-root-密码" tabindex="-1"><a class="header-anchor" href="#linux-系统重置-root-密码" aria-hidden="true">#</a> Linux 系统重置 root 密码</h2><ol><li><p>重启 Linux 系统主机并出现引导界面时，按下键盘上的 <code>e</code> 键进入内核编辑界面</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Red Hat Enterprise Linux <span class="token punctuation">(</span><span class="token number">4.18</span>.0-80.el8.x86_64<span class="token punctuation">)</span> <span class="token number">8.0</span> <span class="token punctuation">(</span>Ootpa<span class="token punctuation">)</span>
