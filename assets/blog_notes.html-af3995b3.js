import{_ as r,Z as v,$ as k,a0 as m,a2 as n,a3 as s,a1 as a,a5 as l,a4 as t,F as i}from"./framework-42112a7a.js";const g={},b=n("div",{class:"hint-container info"},[n("p",{class:"hint-container-title"},"相关信息"),n("p",null,"如果想拥有更多丰富的笔记表现力，让自己阅读时，不处于大片黑白的世界里，本内容会让您的笔记句句深入记忆的深处😸"),n("div",{style:{"text-align":"right"}},[n("p",null,"2023-04-19 @Sankgao")])],-1),h={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},y={href:"https://theme-hope.vuejs.press/zh/",target:"_blank",rel:"noopener noreferrer"},x=t(`<h2 id="使用-emoji-表情" tabindex="-1"><a class="header-anchor" href="#使用-emoji-表情" aria-hidden="true">#</a> 使用 emoji 表情</h2><p>阅读大片大片的文字难免产生视觉疲劳，而使用 <code>emoji</code> 表情，不仅缓解精神的渐眠，也会胜过千言。</p><p>在 <code>Markdown</code> 里，使用 <code>:表情:</code> 输入表情，如：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>您好 :smile:，我喜欢 :dog:，我小时候经常拿 :100:分哦~~~，欢迎来到我的博客 :heart:，一起学习吧 :muscle:
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>效果：</strong></p><blockquote><p>您好 😄，我喜欢 🐶，我小时候经常拿💯分哦~~~，欢迎来到我的博客 ❤️，一起学习吧 💪</p></blockquote><p>很多指令肯定是记不了的，我们可以也可以去特定的网站获取表情的格式。也可以 copy 一个表情过来，Markdown 自动解析表情。</p><p>分享一些 emoji 网站：</p>`,8),_={href:"https://www.webfx.com/tools/emoji-cheat-sheet",target:"_blank",rel:"noopener noreferrer"},f=n("code",null,":表情:",-1),w={href:"https://emojipedia.org/",target:"_blank",rel:"noopener noreferrer"},j={href:"https://github.com/carloscuesta/gitmoji",target:"_blank",rel:"noopener noreferrer"},C=t(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>windows 系统下按 <kbd>Win</kbd> + <kbd>.</kbd> 快速打开表情选择框（不是右侧小键盘的 <kbd>.</kbd>）</p></div><h2 id="外部链接" tabindex="-1"><a class="header-anchor" href="#外部链接" aria-hidden="true">#</a> 外部链接</h2><p>使用外部链接，文字会变色，并且可以点击跳转，格式如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[VuePress-v2 官网](https://v2.vuepress.vuejs.org/zh/)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>效果：</strong></p>`,5),q={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},B=t(`<h2 id="文本高亮" tabindex="-1"><a class="header-anchor" href="#文本高亮" aria-hidden="true">#</a> 文本高亮</h2><p>使用 <code>&lt;mark&gt;</code> 标签或者 <code>\`</code> 让文本高亮。</p><p><code>&lt;mark&gt;</code> 标签经常用于文字的突出；如果是一段字符串，用的是 <code>\`</code> 包裹起来。</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token code-snippet code keyword">\`Vdoing\`</span> 是一款简洁高效的 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>mark</span><span class="token punctuation">&gt;</span></span>知识管理&amp;博客<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mark</span><span class="token punctuation">&gt;</span></span> 主题
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="徽章" tabindex="-1"><a class="header-anchor" href="#徽章" aria-hidden="true">#</a> 徽章</h2><h3 id="内置" tabindex="-1"><a class="header-anchor" href="#内置" aria-hidden="true">#</a> 内置</h3>`,37),F={href:"https://vuepress.vuejs.org/zh/guide/using-vue.html#badge",target:"_blank",rel:"noopener noreferrer"},V=t(`<div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">####</span> 《沁园春·雪》 &lt;Badge text=&quot;摘&quot;/&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>type 有三个参数：<code>tip</code>、<code>warning</code>、<code>error</code>。默认是 <code>tip</code></li><li>vertical 有两个参数：<code>top</code>、<code>middle</code>。默认是 <code>top</code></li></ul><p>直接在 Markdown 文件使用，效果如下：</p>`,3),G={id:"《沁园春·雪》",tabindex:"-1"},E=n("a",{class:"header-anchor",href:"#《沁园春·雪》","aria-hidden":"true"},"#",-1),I=n("h3",{id:"外置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#外置","aria-hidden":"true"},"#"),s(" 外置")],-1),A={href:"https://shields.io/",target:"_blank",rel:"noopener noreferrer"},P=t(`<div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token url"><span class="token operator">!</span>[<span class="token content">stars</span>](<span class="token url">https://img.shields.io/github/stars/Kele-Bingtang/notes-blog</span>)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img.shields.io/github/stars/Kele-Bingtang/notes-blog" alt="访问量" loading="lazy"> <img src="https://img.shields.io/github/stars/Kele-Bingtang/notes-blog?style=social" alt="stars" loading="lazy"> <img src="https://img.shields.io/badge/kbt-冰糖-green" alt="name" loading="lazy"></p>`,2),M={href:"https://shields.io/",target:"_blank",rel:"noopener noreferrer"},K=t(`<h2 id="信息框容器" tabindex="-1"><a class="header-anchor" href="#信息框容器" aria-hidden="true">#</a> 信息框容器</h2><p>以下一些内容是 Vdoing 主题提供，并非官方提供。</p><p>输入：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: tip
这是一条提示
:::
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>效果：</p>`,6),S=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"pnpm"),s(),n("span",{class:"token function"},"install"),s(`
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),J=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),W={class:"hint-container warning"},Z=n("p",{class:"hint-container-title"},"注意",-1),$=n("p",null,[s("您必须在 "),n("code",null,"<CodeGroupItem>"),s(" 的开始标签和代码块之间添加一个空行，否则代码块无法被 Markdown 正确解析")],-1),H=n("p",null,[s("所有内容首先都必须是合法的 Markdown，然后才是一个 "),n("code",null,"Vue SFC"),s("。")],-1),O={href:"https://v2.vuepress.vuejs.org/zh/advanced/cookbook/markdown-and-vue-sfc.html",target:"_blank",rel:"noopener noreferrer"},Q=n("p",null,"或者您可以选择使用自定义容器",-1),X=t(`<h2 id="普通卡片列表" tabindex="-1"><a class="header-anchor" href="#普通卡片列表" aria-hidden="true">#</a> 普通卡片列表</h2><p>如果想使用 <mark>友链</mark> 功能，但是 vdoing 主题并没有直接在首页实现该功能，要么使用 <strong>卡片列表</strong>，要么自己手动实现html。而 <strong>卡片列表</strong> 目前只能使用在 Markdown 文档里，下方介绍。</p><p>普通卡片列表容器，可用于 <code>友情链接</code>、<code>项目推荐</code>、<code>诗词展示</code> 等。</p><p>输入：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">::</span><span class="token punctuation">:</span> cardList
\`\`\`yaml
...
::::
  ...
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">&#39;Javascript code example&#39;</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>::: ::::</p>`,18);function ln(pn,cn){const e=i("ExternalLinkIcon"),p=i("Badge"),o=i("code-block"),d=i("code-group"),c=i("CodeGroupItem"),u=i("CodeGroup");return v(),k("div",null,[b,m(" more "),n("p",null,[s("本内容来自 "),n("a",h,[s("VuePress-v2 官网"),a(e)]),s(" 和 "),n("a",y,[s("vuepress-theme-hope 主题官网"),a(e)]),s("，有部分是自己总结的")]),x,n("ul",null,[n("li",null,[n("a",_,[s("emoji 表情备忘录"),a(e)]),s("：有很多表情的格式("),f,s(")")]),n("li",null,[n("a",w,[s("emoji 表情"),a(e)]),s("：有很多表情可以 copy")]),n("li",null,[n("a",j,[s("gitmoji"),a(e)]),s(" 通过 emoji 表达 git 的操作内容")])]),C,n("p",null,[n("a",q,[s("VuePress-v2 官网"),a(e)])]),B,n("p",null,[s("官方自带。详细使用可前往官网 "),n("a",F,[s("Badge"),a(e)]),s("。")]),V,n("h4",G,[E,s(" 《沁园春·雪》 "),a(p,{text:"摘"})]),n("p",null,[s("北国风光"),a(p,{text:"注释",type:"warning"}),s("，千里冰封，万里雪飘。")]),n("blockquote",null,[a(p,{text:"译文",type:"error",vertical:"middle"}),s(": 北方的风光。")]),I,n("p",null,[s("如果想用更多的自定义徽章，可使用 "),n("a",A,[s("Shields"),a(e)]),s(" 来生成")]),P,n("p",null,[s("如果没接触过 Shields，"),n("a",M,[s("Shields 官网"),a(e)])]),K,n("div",N,[n("p",null,[s("来自 "),n("a",z,[s("VuePress 官网"),a(e)])])]),D,n("h2",L,[T,s(" 代码块选项卡"),a(p,{text:"v1.8.0+"})]),R,a(d,null,{default:l(()=>[a(o,{title:"YARN",active:""},{default:l(()=>[s(" ```bash yarn add vuepress-theme-vdoing -D ``` ")]),_:1}),a(o,{title:"NPM"},{default:l(()=>[s(" ```bash npm install vuepress-theme-vdoing -D ``` ")]),_:1})]),_:1}),Y,a(u,null,{default:l(()=>[a(c,{title:"PNPM",active:""},{default:l(()=>[S]),_:1}),a(c,{title:"YARN"},{default:l(()=>[U]),_:1}),a(c,{title:"NPM"},{default:l(()=>[J]),_:1})]),_:1}),n("div",W,[Z,$,H,n("p",null,[s("了解更多："),n("a",O,[s("Cookbook > Markdown 与 Vue SFC"),a(e)])]),Q]),X,n("h2",nn,[sn,s(" 图文卡片列表"),a(p,{text:"v1.1.0 +"})]),an,n("p",null,[s("官网："),n("a",en,[s("https://github.com/pskordilakis/vuepress-plugin-tabs"),a(e)])]),tn])}const dn=r(g,[["render",ln],["__file","blog_notes.html.vue"]]);export{dn as default};
