import{_ as n,o as s,c as a,f as e}from"./app-3d6ff087.js";const t={},p=e(`<p>变量是存放数据值的容器。</p><p>与其他编程语言不同，Python 没有声明变量的命令。</p><p>首次为其赋值时，才会创建变量。</p><p>语法格式：<code>variablename = value</code>。</p><p>字符串变量可以使用单引号或双引号进行声明。例如：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>my_name <span class="token operator">=</span> <span class="token string">&#39;TOM&#39;</span>
