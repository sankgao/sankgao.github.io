...
test02
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看工作区已修改文件的差异" tabindex="-1"><a class="header-anchor" href="#查看工作区已修改文件的差异" aria-hidden="true">#</a> 查看工作区已修改文件的差异</h3>`,10),u=e(`<ol><li><p>删除 <code>test02.txt</code> 文件，修改 <code>test01.txt</code> 文件，添加新 <code>test03.txt</code> 文件</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">rm</span> test02.txt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,48);function h(g,f){const a=l("RouterLink");return c(),o("div",null,[p,s("p",null,[n("查看工作区已修改（包括已修改的文件或已删除的文件，不包括新文件）但未暂存（"),t(a,{to:"/computers/commands/git/git_add.html"},{default:i(()=>[n("git add")]),_:1}),n("）到暂存区文件的差异。")]),u,s("p",null,[n("使用 "),v,n(" 或 "),m,n(" 选项，查看工作区通过 "),t(a,{to:"/computers/commands/git/git_add.html"},{default:i(()=>[n("git add")]),_:1}),n(" 添加到暂存区（包括已修改的文件、已删除的文件或新文件）文件的差异。不包括未添加到暂存区文件。")]),b])}const w=d(r,[["render",h],["__file","git_diff.html.vue"]]);export{w as default};
