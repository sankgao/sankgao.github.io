import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as p,c,b as n,e as s,d as a,w as o,f as l}from"./app-bjPi1agL.js";const d="/assets/sign_in-nDIQZjm6.jpg",u="/assets/account-5eRXzyd2.png",v="/assets/admin_front_page-DbpTPQB9.jpg",m="/assets/authorization-gnYuTMqA.jpg",k="/assets/authentication-OsYqIDe6.jpg",b="/assets/server_error-d8Fsw7QS.jpg",g="/assets/gerrit_front_page-4qw11ypZ.jpg",h="/assets/not_found-V_R20r_t.jpg",_={},f={class:"hint-container info"},y=n("p",{class:"hint-container-title"},"相关信息",-1),w=n("p",null,[s("此次安装的是 "),n("code",null,"Gerrit-3.9.1"),s(" 版本，需要 "),n("code",null,"Java 17"),s(" 版本环境")],-1),x=n("code",null,"Gerrit-3.9.1",-1),G={href:"https://gerrit-releases.storage.googleapis.com/index.html",target:"_blank",rel:"noopener noreferrer"},I=n("code",null,"Java 17",-1),S={href:"https://www.oracle.com/cn/java/technologies/downloads/#java17",target:"_blank",rel:"noopener noreferrer"},T=n("h2",{id:"基础环境",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基础环境","aria-hidden":"true"},"#"),s(" 基础环境")],-1),N=n("p",null,[s("安装 "),n("code",null,"Gerrit-3.9.1"),s(" 需要 "),n("code",null,"Java 17"),s(" 和 "),n("code",null,"git"),s(" 环境。")],-1),j=l(`<p>创建 <code>gerrit</code> 用户密码，并加入 <code>sudoers</code> 组。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">useradd</span> <span class="token parameter variable">-s</span> /bin/bash <span class="token parameter variable">-m</span> gerrit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>listen</strong>：Nginx 监听端口</li><li><strong>auth_basic_user_file</strong>：HTTP 认证文件地址，用于 Gerrit 登录</li><li><strong>proxy_pass</strong>：需要代理 Gerrit 的地址及端口</li></ul>`,33),R={class:"hint-container info"},P=n("p",{class:"hint-container-title"},"相关信息",-1),L={href:"http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.1/config-reverseproxy.html#_apache_2_configuration",target:"_blank",rel:"noopener noreferrer"},C=l(`<p>创建 <code>/home/gerrit/review_site/etc/.password</code> 文件，并新增用户密码：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">su</span> - gerrit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><p>再次访问 <code>http://10.1.1.10:8081/</code> 代理地址：</p><figure><img src="`+g+'" alt="首页" tabindex="0" loading="lazy"><figcaption>首页</figcaption></figure><h2 id="启动-停止守护进程" tabindex="-1"><a class="header-anchor" href="#启动-停止守护进程" aria-hidden="true">#</a> 启动/停止守护进程</h2><p>要控制在后台运行的 <code>Gerrit Code Review</code> 守护进程，请使用由 <code>init</code> 创建的 <code>rc.d</code> 样式启动脚本：</p><ul><li><strong>服务运行</strong>：<code>review_site/bin/gerrit.sh start</code></li><li><strong>服务停止</strong>：<code>review_site/bin/gerrit.sh stop</code></li><li><strong>服务重启</strong>：<code>review_site/bin/gerrit.sh restart</code></li><li><strong>服务状态</strong>：<code>review_site/bin/gerrit.sh status</code></li></ul><h2 id="查看已安装插件信息" tabindex="-1"><a class="header-anchor" href="#查看已安装插件信息" aria-hidden="true">#</a> 查看已安装插件信息</h2><p>使用 <code>gerrit</code> 管理员用户登录 Gerrit Web 服务器，依次点击 <em>BROWSE -&gt; Plugins</em>。</p><p>在插件页面随便点一个插件名，如出现以下错误：</p><figure><img src="'+h+'" alt="找不到页面" tabindex="0" loading="lazy"><figcaption>找不到页面</figcaption></figure><p>因为访问的 URL 地址没有带端口号，在 URL 地址中添加访问端口即可。例如：</p><p>原 URL 地址：<code>http://10.1.1.10/plugins/hooks/Documentation/index.html</code> 修改后的 URL 地址：<code>http://10.1.1.10:8081/plugins/hooks/Documentation/index.html</code></p>',31);function q(D,E){const e=t("ExternalLinkIcon"),i=t("RouterLink");return p(),c("div",null,[n("div",f,[y,w,n("ul",null,[n("li",null,[x,s(),n("a",G,[s("下载地址"),a(e)]),s("，根据版本下载")]),n("li",null,[I,s(),n("a",S,[s("下载地址"),a(e)])])])]),T,N,n("ul",null,[n("li",null,[a(i,{to:"/computers/dev_env/jdk.html"},{default:o(()=>[s("Java 安装教程")]),_:1})]),n("li",null,[a(i,{to:"/computers/dev_env/git.html"},{default:o(()=>[s("Git 安装教程")]),_:1})])]),j,n("div",R,[P,n("p",null,[s("如果使用 Apache2 进行代理，参考 "),n("a",L,[s("官网文档"),a(e)])])]),C])}const A=r(_,[["render",q],["__file","install.html.vue"]]);export{A as default};
