...
<span class="token code-block language-bash language-bash language-bash">pnpm add -D vuepress-theme-hope</span>
<span class="token punctuation">\`\`\`</span></span>

@tab yarn

<span class="token code"><span class="token punctuation">\`\`\`</span><span class="token code-language">bash</span>
<span class="token code-block language-bash language-bash language-bash">yarn add -D vuepress-theme-hope</span>
<span class="token punctuation">\`\`\`</span></span>

@tab:active npm

<span class="token code"><span class="token punctuation">\`\`\`</span><span class="token code-language">bash</span>
<span class="token code-block language-bash language-bash language-bash">npm i -D vuepress-theme-hope</span>
<span class="token punctuation">\`\`\`</span></span>
