...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><p>再次访问 <code>http://10.1.1.10:8081/</code> 代理地址：</p><figure><img src="`+g+'" alt="首页" tabindex="0" loading="lazy"><figcaption>首页</figcaption></figure><h2 id="启动-停止守护进程" tabindex="-1"><a class="header-anchor" href="#启动-停止守护进程" aria-hidden="true">#</a> 启动/停止守护进程</h2><p>要控制在后台运行的 <code>Gerrit Code Review</code> 守护进程，请使用由 <code>init</code> 创建的 <code>rc.d</code> 样式启动脚本：</p><ul><li><strong>服务运行</strong>：review_site/bin/gerrit.sh start</li><li><strong>服务停止</strong>：review_site/bin/gerrit.sh stop</li><li><strong>服务重启</strong>：review_site/bin/gerrit.sh restart</li><li><strong>服务状态</strong>：review_site/bin/gerrit.sh status</li></ul><h2 id="查看已安装插件信息" tabindex="-1"><a class="header-anchor" href="#查看已安装插件信息" aria-hidden="true">#</a> 查看已安装插件信息</h2><p>使用 <code>gerrit</code> 管理员用户登录 Gerrit Web 服务器，依次点击 <em>BROWSE -&gt; Plugins</em>。</p><p>在插件页面随便点一个插件名，如出现以下错误：</p><figure><img src="'+h+'" alt="找不到页面" tabindex="0" loading="lazy"><figcaption>找不到页面</figcaption></figure><p>因为访问的 URL 地址没有带端口号，在 URL 地址中添加访问端口即可。例如：原 URL 地址 <code>http://10.1.1.10/plugins/hooks/Documentation/index.html</code> 修改后的 URL 地址 <code>http://10.1.1.10/plugins/hooks/Documentation/index.html</code>。</p>',30);function q(D,E){const e=t("ExternalLinkIcon"),i=t("RouterLink");return p(),c("div",null,[n("div",f,[y,w,n("ul",null,[n("li",null,[x,s(),n("a",G,[s("下载地址"),a(e)]),s("，根据版本下载")]),n("li",null,[I,s(),n("a",S,[s("下载地址"),a(e)])])])]),T,N,n("ul",null,[n("li",null,[a(i,{to:"/computers/dev_env/jdk.html"},{default:o(()=>[s("Java 安装教程")]),_:1})]),n("li",null,[a(i,{to:"/computers/dev_env/git.html"},{default:o(()=>[s("Git 安装教程")]),_:1})])]),j,n("div",R,[P,n("p",null,[s("如果使用 Apache2 进行代理，参考 "),n("a",L,[s("官网文档"),a(e)])])]),C])}const A=r(_,[["render",q],["__file","install.html.vue"]]);export{A as default};
