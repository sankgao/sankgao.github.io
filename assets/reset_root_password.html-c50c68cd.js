import{_ as s,X as n,Y as a,a3 as e}from"./framework-d95ce41d.js";const o={},t=e(`<h2 id="linux-系统重置-root-密码" tabindex="-1"><a class="header-anchor" href="#linux-系统重置-root-密码" aria-hidden="true">#</a> Linux 系统重置 root 密码</h2><ol><li><p>重启 Linux 系统主机并出现引导界面时，按下键盘上的 <code>e</code> 键进入内核编辑界面</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Red Hat Enterprise Linux <span class="token punctuation">(</span><span class="token number">4.18</span>.0-80.el8.x86_64<span class="token punctuation">)</span> <span class="token number">8.0</span> <span class="token punctuation">(</span>Ootpa<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>重新挂载已经挂载了的文件系统（以读写权限挂载），需要注意的是，挂载点必须是一个已经存在的目录，这个目录可以不为空</p></div><p><strong>mount -o remount,rw /sysroot</strong>：重新以可读可写的方式挂载 <code>/sysroot</code><strong>chroot /sysroot</strong>：改变根目录为 <code>/sysroot</code><strong>passwd</strong>：按提示修改 root 密码 <strong>touch /.autorelabel</strong>：查看当前目录下是否有 <strong>.autorelabel</strong> 文件，如果没有必须创建该文件，否则将无法正常启动系统 <strong>exit</strong>：退出 <strong>logout</strong>：重启系统</p></li></ol>`,2),i=[t];function l(r,c){return n(),a("div",null,i)}const p=s(o,[["render",l],["__file","reset_root_password.html.vue"]]);export{p as default};
