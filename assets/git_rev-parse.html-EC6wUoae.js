...
refs/heads/main
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取-git-目录的路径" tabindex="-1"><a class="header-anchor" href="#获取-git-目录的路径" aria-hidden="true">#</a> 获取 Git 目录的路径</h3><p>例如：在根目录下，返回 Git 仓库的 <code>.git</code> 目录的路径。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> rev-parse --git-dir

.git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>例如：在非根目录下，返回 Git 仓库的 <code>.git</code> 目录的路径。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> a/b/c
<span class="token function">git</span> rev-parse --git-dir
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取工作区的相对目录" tabindex="-1"><a class="header-anchor" href="#获取工作区的相对目录" aria-hidden="true">#</a> 获取工作区的相对目录</h3><p>例如：获取相对于工作区根目录的相对目录。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> rev-parse --show-prefix

a/b/c
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取工作区的相对目录-1" tabindex="-1"><a class="header-anchor" href="#获取工作区的相对目录-1" aria-hidden="true">#</a> 获取工作区的相对目录</h3><p>例如：获取从当前目录（<code>cd</code>）后退到工作区的根的深度。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> rev-parse --show-cdup
...
4637c7d9d5ed2aa5695366d1daa011bd57fc4fe9
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,44),t=[i];function r(l,c){return a(),s("div",null,t)}const u=e(d,[["render",r],["__file","git_rev-parse.html.vue"]]);export{u as default};
