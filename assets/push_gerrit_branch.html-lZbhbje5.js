import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as n,f as e}from"./app-BMJBhAfC.js";const r={},i=e(`<h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2><p>直接使用 <code>git push origin master</code> 命令推送到远程 Git 仓库会出现以下错误：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Enumerating objects: <span class="token number">4</span>, done.
