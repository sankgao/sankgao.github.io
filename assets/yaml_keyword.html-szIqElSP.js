...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>额外细节：</strong></p><ul><li>如果您使用 <code>Windows Batch</code> 运行您的 <code>shell</code> 脚本，您需要用 <code>%</code> 替换 <code>$</code>。例如：<code>key：%CI_COMMIT_REF_SLUG%</code></li><li><code>cache:key</code> 值不能包含： <ul><li><code>/</code> 字符，或等效的 URI 编码的 <code>%2F</code></li><li>只有 <code>.</code> 字符（任何数字），或等效的 URI 编码的 <code>%2E</code></li></ul></li><li>缓存在作业之间共享，因此如果您为不同的作业使用不同的路径，您还应该设置不同的 <code>cache:key</code>，否则缓存内容可能会被覆盖</li></ul><h3 id="cache-paths" tabindex="-1"><a class="header-anchor" href="#cache-paths" aria-hidden="true">#</a> cache:paths</h3><p>缓存 <code>binaries</code> 中以 <code>.apk</code> 和当前目录中以 <code>.config</code> 文件结尾的所有文件：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">rspec</span><span class="token punctuation">:</span>
  <span class="token key atrule">script</span><span class="token punctuation">:</span>
    <span class="token punctuation">-</span> echo &quot;This job uses a cache.&quot;
  <span class="token key atrule">cache</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>额外细节：</strong></p><ul><li><code>cache:paths</code> 关键字包括文件，即使它们未被跟踪或在您的 <code>.gitignore</code> 文件中。</li></ul>`,68);function k(v,b){const n=c("ExternalLinkIcon");return t(),l("div",null,[s("p",null,[p,e(" 文件中关键字示例，查看官网 "),s("a",u,[e(".gitlab-ci.yml"),i(n)]),e(" 语法参考。")]),r])}const g=a(d,[["render",k],["__file","yaml_keyword.html.vue"]]);export{g as default};
