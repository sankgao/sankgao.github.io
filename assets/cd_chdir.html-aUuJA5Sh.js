...
E:\\&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="显示指定磁盘中当前目录的名称" tabindex="-1"><a class="header-anchor" href="#显示指定磁盘中当前目录的名称" aria-hidden="true">#</a> 显示指定磁盘中当前目录的名称</h3><p>例如：显示指定磁盘中当前目录的名称。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>E:\\&gt;cd c:
C:\\Users\\user
...
E:\\&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23),t=[n];function c(r,l){return d(),a("div",null,t)}const m=e(s,[["render",c],["__file","cd_chdir.html.vue"]]);export{m as default};
