...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>为避免引用（或者提交 ID）和路径同名而发生冲突，可以在 <code>&lt;path&gt;</code> 前用两个连续的短线（<code>--</code>）作为分隔。</p>`,2),_=n("h2",{id:"撤销已暂存的文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#撤销已暂存的文件","aria-hidden":"true"},"#"),s(" 撤销已暂存的文件")],-1),x=i(`<h3 id="依次撤销" tabindex="-1"><a class="header-anchor" href="#依次撤销" aria-hidden="true">#</a> 依次撤销</h3><p>先将指定文件从暂存区撤销到未暂存清单中，再撤销对指定文件的修改。</p><p>例如：不小心将 <code>test02.txt</code> 文件，提交到暂存区。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span>
