import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as p,c,b as n,e as s,d as a,w as o,f as l}from"./app-CSBT9Nwz.js";const d="/assets/sign_in-nDIQZjm6.jpg",u="/assets/account-5eRXzyd2.png",v="/assets/admin_front_page-DbpTPQB9.jpg",m="/assets/authorization-gnYuTMqA.jpg",k="/assets/authentication-OsYqIDe6.jpg",b="/assets/server_error-d8Fsw7QS.jpg",g="/assets/gerrit_front_page-4qw11ypZ.jpg",h={},_={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"相关信息",-1),y=n("p",null,[s("此次安装的是 "),n("code",null,"Gerrit-3.9.1"),s(" 版本，需要 "),n("code",null,"Java 17"),s(" 版本环境")],-1),w=n("code",null,"Gerrit-3.9.1",-1),x={href:"https://gerrit-releases.storage.googleapis.com/index.html",target:"_blank",rel:"noopener noreferrer"},G=n("code",null,"Java 17",-1),I={href:"https://www.oracle.com/cn/java/technologies/downloads/#java17",target:"_blank",rel:"noopener noreferrer"},S=n("h2",{id:"基础环境",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基础环境","aria-hidden":"true"},"#"),s(" 基础环境")],-1),T=n("p",null,[s("安装 "),n("code",null,"Gerrit-3.9.1"),s(" 需要 "),n("code",null,"Java 17"),s(" 和 "),n("code",null,"git"),s(" 环境。")],-1),N=l(`<p>创建 <code>gerrit</code> 用户密码，并加入 <code>sudoers</code> 组。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">useradd</span> <span class="token parameter variable">-s</span> /bin/bash <span class="token parameter variable">-m</span> gerrit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>listen</strong>：Nginx 监听端口</li><li><strong>auth_basic_user_file</strong>：HTTP 认证文件地址，用于 Gerrit 登录</li><li><strong>proxy_pass</strong>：需要代理 Gerrit 的地址及端口</li></ul>`,33),j={class:"hint-container info"},P=n("p",{class:"hint-container-title"},"相关信息",-1),R={href:"http://gerrit-documentation.storage.googleapis.com/Documentation/3.9.1/config-reverseproxy.html#_apache_2_configuration",target:"_blank",rel:"noopener noreferrer"},L=l(`<p>创建 <code>/home/gerrit/review_site/etc/.password</code> 文件，并新增用户密码：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">su</span> - gerrit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><p>再次访问 <code>http://10.1.1.10:8081/</code> 代理地址：</p><figure><img src="`+g+'" alt="首页" tabindex="0" loading="lazy"><figcaption>首页</figcaption></figure><h2 id="启动-停止守护进程" tabindex="-1"><a class="header-anchor" href="#启动-停止守护进程" aria-hidden="true">#</a> 启动/停止守护进程</h2><p>要控制在后台运行的 <code>Gerrit Code Review</code> 守护进程，请使用由 <code>init</code> 创建的 <code>rc.d</code> 样式启动脚本：</p><ul><li><strong>服务运行</strong>：review_site/bin/gerrit.sh start</li><li><strong>服务停止</strong>：review_site/bin/gerrit.sh stop</li><li><strong>服务重启</strong>：review_site/bin/gerrit.sh restart</li><li><strong>服务状态</strong>：review_site/bin/gerrit.sh status</li></ul>',25);function C(q,H){const e=t("ExternalLinkIcon"),i=t("RouterLink");return p(),c("div",null,[n("div",_,[f,y,n("ul",null,[n("li",null,[w,s(),n("a",x,[s("下载地址"),a(e)]),s("，根据版本下载")]),n("li",null,[G,s(),n("a",I,[s("下载地址"),a(e)])])])]),S,T,n("ul",null,[n("li",null,[a(i,{to:"/computers/dev_env/jdk.html"},{default:o(()=>[s("Java 安装教程")]),_:1})]),n("li",null,[a(i,{to:"/computers/dev_env/git.html"},{default:o(()=>[s("Git 安装教程")]),_:1})])]),N,n("div",j,[P,n("p",null,[s("如果使用 Apache2 进行代理，参考 "),n("a",R,[s("官网文档"),a(e)])])]),L])}const D=r(h,[["render",C],["__file","install.html.vue"]]);export{D as default};
