import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as d,c as i,f as n}from"./app-QAJaivAq.js";const s={},l=n(`<h2 id="描述" tabindex="-1"><a class="header-anchor" href="#描述" aria-hidden="true">#</a> 描述</h2><p><code>ftp</code> 用于在运行文件传输协议（FTP）服务器服务的计算机之间双向传输文件。此命令可以通过处理 ASCII 文本文件以交互方式或批处理方式使用。</p><ul><li><code>ftp</code> 命令行参数区分大小写</li><li>仅当 Internet 协议（TCP/IP）协议作为组件安装在网络连接的网络适配器的属性中时，此命令才可用</li><li><code>ftp</code> 命令可以交互使用。启动之后，FTP 会创建一个子环境，您可以在其中使用 <code>ftp</code> 命令。可以键入 <code>quit</code> 命令返回到命令提示符。当 FTP 子环境正在运行时，<code>ftp&gt;</code> 命令提示符会表明这一点</li><li>安装了 IPv6 协议时，<code>ftp</code> 命令支持使用 IPv6</li></ul><h2 id="选项" tabindex="-1"><a class="header-anchor" href="#选项" aria-hidden="true">#</a> 选项</h2><table><thead><tr><th style="text-align:center;">选项</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:center;"><code>-a</code></td><td style="text-align:left;">指定在绑定 FTP 数据连接时可以使用任何本地接口</td></tr><tr><td style="text-align:center;"><code>-i</code></td><td style="text-align:left;">关闭多文件传输过程中的交互式提示</td></tr><tr><td style="text-align:center;"><code>-n</code></td><td style="text-align:left;">以匿名身份登录到 FTP 远程服务器</td></tr><tr><td style="text-align:center;"><code>-v</code></td><td style="text-align:left;">禁止显示远程服务器响应</td></tr><tr><td style="text-align:center;"><code>-v</code></td><td style="text-align:left;">禁止显示远程服务器响应</td></tr><tr><td style="text-align:center;"><code>-s:filename</code></td><td style="text-align:left;">指定包含 <code>ftp</code> 命令的文本文件；命令在 FTP 服务启动后自动运行</td></tr><tr><td style="text-align:center;"><code>/?</code></td><td style="text-align:left;">在命令提示符下显示帮助</td></tr></tbody></table><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h2><table><thead><tr><th style="text-align:center;">命令</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:center;"><a href="#append">append</a></td><td style="text-align:left;">将本地文件内容追加到远程服务器指定文件中</td></tr><tr><td style="text-align:center;"><a href="#bye-%E6%88%96-quit">bye 或 quit</a></td><td style="text-align:left;">结束远程服务器上的 FTP 会话，然后退出</td></tr><tr><td style="text-align:center;"><a href="#cd">cd</a></td><td style="text-align:left;">更改远程服务器上的工作目录</td></tr><tr><td style="text-align:center;"><a href="#close">close</a></td><td style="text-align:left;">结束与远程服务器的 FTP 会话并保持在 <code>ftp&gt;</code> 提示符处</td></tr><tr><td style="text-align:center;"><a href="#debug">debug</a></td><td style="text-align:left;">切换调试模式。默认情况下，调试模式处于关闭状态。如果 “调试模式”处于打开状态，您将看到每个命令都发送到远程服务器，前面带 <code>&gt;</code> 字符</td></tr><tr><td style="text-align:center;"><a href="#delete">delete</a></td><td style="text-align:left;">删除远程服务器上的文件，一次只能删除一个文件</td></tr><tr><td style="text-align:center;"><a href="#dir">dir</a></td><td style="text-align:left;">显示 FTP 远程服务器指定目录中文件和子目录的详细列表，只能指定一个目录</td></tr><tr><td style="text-align:center;"><a href="#disconnect">disconnect</a></td><td style="text-align:left;">断开与远程服务器的连接，并留在 <code>ftp&gt;</code> 提示符</td></tr><tr><td style="text-align:center;"><a href="#get-%E6%88%96-recv">get 或 recv</a></td><td style="text-align:left;">使用当前文件传输类型将远程文件复制到本地计算机，一次只能复制一个文件</td></tr><tr><td style="text-align:center;"><a href="#lcd">lcd</a></td><td style="text-align:left;">更改本地计算机上的工作目录。默认情况下，工作目录是启动 <code>ftp</code> 命令的目录</td></tr><tr><td style="text-align:center;"><a href="#ls">ls</a></td><td style="text-align:left;">显示 FTP 远程服务器指定目录中文件和子目录的缩略列表</td></tr><tr><td style="text-align:center;"><a href="#mdelete">mdelete</a></td><td style="text-align:left;">删除远程服务器上的文件。可以一次删除多个文件，只能删除当前目录下的文件</td></tr><tr><td style="text-align:center;"><a href="#mdir">mdir</a></td><td style="text-align:left;">显示 FTP 远程服务器指定目录中文件和子目录的详细列表。可以一次显示一个或多个目录，如果不将结果保存到本地文件中，必须以连字符（<code>-</code>）结尾</td></tr><tr><td style="text-align:center;"><a href="#mget">mget</a></td><td style="text-align:left;">使用当前文件传输类型将远程文件复制到本地计算机。可以一次复制一个或多个文件，但需要提前切换到要复制的本地目录中，且不能修改文件名</td></tr><tr><td style="text-align:center;"><a href="#mkdir">mkdir</a></td><td style="text-align:left;">在 FTP 远程服务器中创建目录，一次只能创建一个目录</td></tr><tr><td style="text-align:center;"><a href="#mls">mls</a></td><td style="text-align:left;">显示 FTP 远程服务器指定目录中文件和子目录的缩略列表。可以一次显示一个或多个目录，如果不将结果保存到本地文件中，必须以连字符（<code>-</code>）结尾</td></tr><tr><td style="text-align:center;"><a href="#mput">mput</a></td><td style="text-align:left;">使用当前文件传输类型将本地文件复制到远程服务器。可以一次复制一个或多个文件，但需要提前切换到要复制的远程服务器目录中，且不能修改文件名</td></tr><tr><td style="text-align:center;"><a href="#open">open</a></td><td style="text-align:left;">连接到指定的 FTP 远程服务器</td></tr><tr><td style="text-align:center;"><a href="#prompt">prompt</a></td><td style="text-align:left;">打开和关闭 “提示” 模式。默认情况下，“提示” 模式处于打开状态。如果打开 “提示” 模式，<code>ftp</code> 命令会在传输多个文件期间提示，允许您有选择性地检索或存储文件</td></tr><tr><td style="text-align:center;"><a href="#put-%E6%88%96-send">put 或 send</a></td><td style="text-align:left;">使用当前文件传输类型将本地文件复制到远程服务器。一次只能复制一个文件</td></tr><tr><td style="text-align:center;"><a href="#pwd">pwd</a></td><td style="text-align:left;">显示当前远程服务器目录</td></tr><tr><td style="text-align:center;"><a href="#remotehelp">remotehelp</a></td><td style="text-align:left;">显示远程命令的帮助</td></tr><tr><td style="text-align:center;"><a href="#rename">rename</a></td><td style="text-align:left;">重命名远程文件</td></tr><tr><td style="text-align:center;"><a href="#rmdir">rmdir</a></td><td style="text-align:left;">删除远程目录，只能删除空目录</td></tr><tr><td style="text-align:center;"><a href="#status">status</a></td><td style="text-align:left;">显示 FTP 连接的当前状态</td></tr><tr><td style="text-align:center;"><a href="#type">type</a></td><td style="text-align:left;">设置或显示文件传输类型</td></tr><tr><td style="text-align:center;"><a href="#user">user</a></td><td style="text-align:left;">指定远程服务器的用户及密码</td></tr><tr><td style="text-align:center;"><a href="#verbose">verbose</a></td><td style="text-align:left;">切换详细模式。默认情况下，详细模式处于打开状态。启用详细模式时，将显示所有 <code>ftp</code> 命令响应。当文件传输完成时，还会显示有关传输效率的统计信息</td></tr><tr><td style="text-align:center;"><a href="#help">help</a></td><td style="text-align:left;">显示 <code>ftp</code> 命令的帮助</td></tr></tbody></table><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><h3 id="登录服务器" tabindex="-1"><a class="header-anchor" href="#登录服务器" aria-hidden="true">#</a> 登录服务器</h3><p>例如：登录到 <code>192.168.10.10</code> FTP 远程服务器。</p><p>查看当前 <code>E:\\ftp</code> 目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>E:\\ftp&gt;dir /b
...
230 User logged in.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="user" tabindex="-1"><a class="header-anchor" href="#user" aria-hidden="true">#</a> user</h3><p>例如：如果已经连接到远程服务器，但还没有登录，可以使用 <code>user</code> 命令进行登录。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; open 192.168.10.10
连接到 192.168.10.10。
220 Microsoft FTP Service
200 OPTS UTF8 command successful - UTF8 encoding now ON.
...
230 User logged in.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="status" tabindex="-1"><a class="header-anchor" href="#status" aria-hidden="true">#</a> status</h3><p>例如：显示 ftp 连接的当前状态。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; status
连接到 192.168.10.10。
类型: ascii；详细: 开 ；铃声: 关 ；提示: 开 ；通配: 开
调试: 关 ；哈希标记打印: 关 。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="type" tabindex="-1"><a class="header-anchor" href="#type" aria-hidden="true">#</a> type</h3><p>ftp 命令支持 ASCII（默认）和二进制（<code>binary</code>）映像文件传输类型：</p><ul><li>建议在传输文本文件时使用 ASCII。在 ASCII 模式下，将执行与网络标准字符集之间的字符转换。例如：根据目标操作系统，在必要时转换行尾字符</li><li>建议在传输可执行文件时使用二进制。在二进制模式下，文件以单字节为单位传输</li></ul><p>例如：设置为二进制文件传输类型，并查看当前文件传输类型。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; type binary
200 Type set to I.
ftp&gt; 
ftp&gt; type
使用 binary 模式传送文件。
...
hello worldtest
E:\\test&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="rename" tabindex="-1"><a class="header-anchor" href="#rename" aria-hidden="true">#</a> rename</h3><p>重命名远程文件。</p><p>例如：将远程 <code>hello01.txt</code> 文件重命名为 <code>hello02.txt</code>。</p><p>查看远程服务器根目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; pwd
257 &quot;/&quot; is current directory.
ftp&gt;
ftp&gt; dir
200 PORT command successful.
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将远程 <code>hello01.txt</code> 文件重命名为 <code>hello02.txt</code>。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; rename hello01.txt hello02.txt
350 Requested file action pending further information.
250 RNTO command successful.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次查看 FTP 当前目录，<code>hello01.txt</code> 文件已重命名为 <code>hello02.txt</code>：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; dir
200 PORT command successful.
125 Data connection already open; Transfer starting.
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="delete" tabindex="-1"><a class="header-anchor" href="#delete" aria-hidden="true">#</a> delete</h3><div class="hint-container tip"><p class="hint-container-title">提示</p><p>如果 <code>delete</code> 命令后跟多个文件，也只会删除第一个文件，其它文件不会删除。</p></div><p>例如：删除 FTP 远程服务器的 <code>test01</code> 目录中 <code>test02.txt</code> 文件。</p><p>查看 FTP 远程服务器的 <code>test01</code> 目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; cd test01
250 CWD command successful.
ftp&gt; ls
200 PORT command successful.
125 Data connection already open; Transfer starting.
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>删除 FTP 远程服务器的 <code>test01</code> 目录中 <code>test02.txt</code> 文件：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt;
ftp&gt; delete test02.txt
250 DELE command successful.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次查看 FTP 远程服务器的 <code>test01</code> 目录，<code>test02.txt</code> 文件已删除：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; ls
200 PORT command successful.
125 Data connection already open; Transfer starting.
test01.txt
test02
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="mdelete" tabindex="-1"><a class="header-anchor" href="#mdelete" aria-hidden="true">#</a> mdelete</h3><p>例如：删除 FTP 远程服务器 <code>test01</code> 目录中 <code>dirlist.txt</code> 和 <code>lslist.txt</code> 文件。</p><p>查看远程 <code>test01</code> 目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; dir test01
200 PORT command successful.
125 Data connection already open; Transfer starting.
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>先切换到远程 <code>test01</code> 目录中：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; cd test01
250 CWD command successful.
ftp&gt; 
ftp&gt; pwd
257 &quot;/test01&quot; is current directory.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>删除 FTP 远程服务器的 <code>dirlist.txt</code> 和 <code>lslist.txt</code> 文件：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; mdelete dirlist.txt lslist.txt
200 Type set to A.
...
250 DELE command successful.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次查看远程 <code>test01</code> 目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; dir ./
200 PORT command successful.
125 Data connection already open; Transfer starting.
07-18-24  10:30AM                   22 test01.txt
07-16-24  06:22PM       &lt;DIR&gt;          test02
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>如果使用 <code>mdelete</code> 命令删除其它目录下的文件，则会报以下错误：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; mdelete test01\\dirlist.txt test01\\lslist.txt
200 Type set to A.
mdelete dirlist.txt? y
...
550 End
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div><h3 id="rmdir" tabindex="-1"><a class="header-anchor" href="#rmdir" aria-hidden="true">#</a> rmdir</h3><p>例如：删除远程 <code>test03</code> 空目录。</p><p>创建 <code>test03</code> 目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; mkdir test03
257 &quot;test03&quot; directory created.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查看 FTP 当前目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; dir
200 PORT command successful.
125 Data connection already open; Transfer starting.
07-15-24  10:50AM       &lt;DIR&gt;          a
07-17-24  02:24PM                    9 filelist.txt
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>删除远程 <code>test03</code> 空目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; rmdir test03
250 XRMD command successful.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次查看 FTP 当前目录：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; dir
200 PORT command successful.
125 Data connection already open; Transfer starting.
07-15-24  10:50AM       &lt;DIR&gt;          a
07-17-24  02:24PM                    9 filelist.txt
...
ftp: 收到 448 字节，用时 0.01秒 37.33千字节/秒。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>如果使用 <code>rmdir</code> 命令删除的不是远程空目录，则会报以下错误：</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; rmdir test02
550-The directory is not empty.
 Win32 error:   The directory is not empty.
 Error details: File system returned an error.
550 End
ftp&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div><h3 id="close" tabindex="-1"><a class="header-anchor" href="#close" aria-hidden="true">#</a> close</h3><p>例如：结束与远程服务器的 ftp 会话并保持在 <code>ftp&gt;</code> 提示符处。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; close
221 Goodbye.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="disconnect" tabindex="-1"><a class="header-anchor" href="#disconnect" aria-hidden="true">#</a> disconnect</h3><p>例如：断开与远程服务器的连接，并留在 <code>ftp&gt;</code> 提示符。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; close
221 Goodbye.
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bye-或-quit" tabindex="-1"><a class="header-anchor" href="#bye-或-quit" aria-hidden="true">#</a> bye 或 quit</h3><p>例如：使用 <code>bye</code> 命令退出 FTP 会话。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; quit
221 Goodbye.

E:\\test&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>或使用 <code>quit</code> 命令退出 FTP 会话。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; quit
221 Goodbye.

E:\\test&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="debug" tabindex="-1"><a class="header-anchor" href="#debug" aria-hidden="true">#</a> debug</h3><p>例如：开启调试模式。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; debug
调试 开 。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>例如：关闭调试模式。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; debug
调试 关 。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="verbose" tabindex="-1"><a class="header-anchor" href="#verbose" aria-hidden="true">#</a> verbose</h3><p>例如：关闭详细模式。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; verbose
详细模式 关 。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>例如：开启详细模式。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; verbose
详细模式 开 。
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="remotehelp" tabindex="-1"><a class="header-anchor" href="#remotehelp" aria-hidden="true">#</a> remotehelp</h3><div class="hint-container tip"><p class="hint-container-title">提示</p><p><code>remotehelp</code> 命令只能对以下远程命令的列表中的命令提供帮助，且命令不能写错。</p></div><p>例如：显示所有远程命令的列表。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; remotehelp
...
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="help" tabindex="-1"><a class="header-anchor" href="#help" aria-hidden="true">#</a> help</h3><p>显示对 ftp 命令的帮助信息。</p><p>例如：显示所有 ftp 命令的列表。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>ftp&gt; help
命令可能是缩写的。  命令为:
...
delete          删除远程文件
ftp&gt; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,241),t=[l];function a(c,r){return d(),i("div",null,t)}const u=e(s,[["render",a],["__file","ftp.html.vue"]]);export{u as default};
