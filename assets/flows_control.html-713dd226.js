import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as t,c as o,b as a,d as e,f as n}from"./app-4d168778.js";const l={},c=n(`<h2 id="条件选择语句" tabindex="-1"><a class="header-anchor" href="#条件选择语句" aria-hidden="true">#</a> 条件选择语句</h2><p>条件选择语句主要有 3 中形式，分别为 <strong>if 语句</strong>、<strong>if···else 语句</strong> 和 <strong>if···elif···else 多分支语句。</strong></p><h3 id="if-语句" tabindex="-1"><a class="header-anchor" href="#if-语句" aria-hidden="true">#</a> if 语句</h3><p><strong>语法格式：</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">if</span> 条件表达式<span class="token punctuation">:</span>
    执行的代码
